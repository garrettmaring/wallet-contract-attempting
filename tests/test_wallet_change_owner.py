...
def test_should_change_owner(accounts, wallet):
    ...
    assert tx.events['OwnerChanged']['oldOwner'] == '0x66aB6D9362d4F35596279692F0251Db635165871', "Old owner emitted correctly"
    assert tx.events['OwnerChanged']['newOwner'] == '0x21b42413bA931038f35e7A5224FaDb065d297Ba3', "New owner emitted correctly"
